...
def Encode_decode_video():
    ...
    for cnt in range(len(rate)):
       ...
       osout = call_bg_file('./VVCS/bin/EncoderAppStatic -c ./VVCS/cfg/encoder_lowdelay_P_vtm.cfg -c ./VVCS/cfg/encoder_VVC_GOP.cfg --InputFile={} --SourceWidth={} --SourceHeight={} --SAO=0 --InitialQP={} --FrameRate={} --FramesToBeEncoded={} --MaxCUSize={} --MaxPartitionDepth={}  --BitstreamFile="{}" --RateControl={} --TargetBitrate={} --ReconFile={}'.format(InputYUV,Width,Hight,QP,fps,NumFrames,MaxCUSize,MaxPartitionDepth,BitstreamFile,RateControl,rate[cnt],ReconYUV),fid)
